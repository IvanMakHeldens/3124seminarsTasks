...
Console.WriteLine("Введите положительные и отрицательные числа, для подсчёта положительных напишите stop");
int countPositive = 0;
while (true)
{
...
Console.WriteLine($"Введено положительных чисел: {countPositive} ");